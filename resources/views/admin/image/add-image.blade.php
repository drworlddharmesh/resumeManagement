    ...
    <div class="col-lg-12">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">
                <strong>Add Payment Image</strong>
            </li>
        </ol>
    </div>
</div>
        ...
        <div class="col-lg-12">
            <div class="ibox">
                ...
                <div class="ibox-content">
                    ...
                    <form role="form" id="addResumeForm" method="post" enctype="multipart/form-data" action="{{ url('admin/image/insert-image') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <center>
                                    <div class="error-div">
                                        <img src="{{ url('storage/app/images/no-image.png') }}" id="video-thumb-img" width="200px">
                                        <br><br>
                                        <div class="btn-group">
