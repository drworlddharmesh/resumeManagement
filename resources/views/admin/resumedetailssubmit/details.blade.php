...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-12">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">
                <a href="{{ url('admin/resumedetailsubmit').'/'.$UserId }}">Resume Details View</a>
            </li>
            ...
            <div class="ibox">
                ...
                <div class="ibox-content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-6" style="overflow-y:scroll; height:600px;">
                            ...
                            <form role="form" id="addHealthConditionForm" method="post" enctype="multipart/form-data" action="{{ url('admin/resumedetails/review-resume-details') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="radio" name="FirstNameStatus" value="1" @if($ResumeDetail->FirstNameStatus == 1) checked  @endif>

                                    <label class="text-success">Approve:</label>
                                    <input type="radio" name="FirstNameStatus" value="2" @if($ResumeDetail->FirstNameStatus == 2) checked  @endif>
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="text-danger">Not Approve:</label>
                                    <input type="radio" name="MiddleNameStatus" value="1" @if($ResumeDetail->MiddleNameStatus == 1) checked  @endif>


                                    <label class="text-success">Approve:</label>
                                    <input type="radio" name="MiddleNameStatus" value="2" @if($ResumeDetail->MiddleNameStatus == 2) checked  @endif>
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="text-danger">Not Approve:</label>
                                    <input type="radio" name="LastNameStatus" value="1"  @if($ResumeDetail->LastNameStatus == 1) checked  @endif>


                                    <label class="text-success">Approve:</label>
                                    <input type="radio" name="LastNameStatus" value="2" @if($ResumeDetail->LastNameStatus == 2) checked  @endif>
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="text-danger">Not Approve:</label>
                                    <input type="radio" name="DateOfBirthStatus" value="1" @if($ResumeDetail->DateOfBirthStatus == 1) checked  @endif>


                                    <label class="text-success">Approve:</label>
                                    <input type="radio" name="DateOfBirthStatus" value="2" @if($ResumeDetail->DateOfBirthStatus == 2) checked  @endif>
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="text-danger">Not Approve:</label>
                                    <input type="radio" name="GenderStatus" value="1"  @if($ResumeDetail->GenderStatus == 1) checked @endif>


                                    <label class="text-success">Approve:</label>
                                    <input type="radio" name="GenderStatus" value="2"  @if($ResumeDetail->GenderStatus == 2) checked @endif>
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="text-danger">Not Approve:</label>
                                    <input type="radio" name="NationalityStatus" value="1"  @if($ResumeDetail->NationalityStatus == 1) checked  @endif>


                                    <label class="text-success">Approve:</label>
                                    <input type="radio" name="NationalityStatus" value="2"  @if($ResumeDetail->NationalityStatus == 2) checked  @endif>
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="text-danger">Not Approve:</label>
                                    <input type="radio" name="MaritalStatus" value="1" @if($ResumeDetail->MaritalStatus == 1) checked  @endif>


                                    <label class="text-success">Approve:</label>
                                    <input type="radio" name="MaritalStatus" value="2" @if($ResumeDetail->MaritalStatus == 2) checked  @endif>
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="text-danger">Not Approve:</label>
                                    <input type="radio" name="PassportStatus" value="1" @if($ResumeDetail->PassportStatus == 1) checked  @endif>


                                    <label class="text-success">Approve:</label>
                                    <input type="radio" name="PassportStatus" value="2"  @if($ResumeDetail->PassportStatus == 2) checked @endif>
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="text-danger">Not Approve:</label>
                                    <input type="radio" name="HobbiesStatus" value="1" @if($ResumeDetail->HobbiesStatus == 1) checked @endif>


                                    <label class="text-success">Approve:</label>
                                    <input type="radio" name="HobbiesStatus" value="2" @if($ResumeDetail->HobbiesStatus == 2) checked @endif>
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="text-danger">Not Approve:</label>
                                    <input type="radio" name="languageKnownStatus" value="1" @if($ResumeDetail->languageKnownStatus == 1) checked  @endif>


                                    <label class="text-success">Approve:</label>
                                    <input type="radio" name="languageKnownStatus" value="2"  @if($ResumeDetail->languageKnownStatus == 2) checked @endif>
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="text-danger">Not Approve:</label>
                                    <input type="radio" name="AddressStatus" value="1" @if($ResumeDetail->AddressStatus == 1) checked  @endif>


                                    <label class="text-success">Approve:</label>
                                    <input type="radio" name="AddressStatus" value="2" @if($ResumeDetail->AddressStatus == 2) checked @endif>
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="text-danger">Not Approve:</label>
                                    <input type="radio" name="LandMarkStatus" value="1" @if($ResumeDetail->LandMarkStatus == 1) checked @endif>


                                    <label class="text-success">Approve:</label>
                                    <input type="radio" name="LandMarkStatus" value="2" @if($ResumeDetail->LandMarkStatus == 2) checked @endif>
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="text-danger">Not Approve:</label>
                                    <input type="radio" name="CityStatus" value="1" @if($ResumeDetail->CityStatus == 1) checked @endif>


                                    <label class="text-success">Approve:</label>
                                    <input type="radio" name="CityStatus" value="2" @if($ResumeDetail->CityStatus == 2) checked @endif>
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="text-danger">Not Approve:</label>
                                    <input type="radio" name="StateStatus" value="1" @if($ResumeDetail->StateStatus == 1) checked @endif>


                                    <label class="text-success">Approve:</label>
                                    <input type="radio" name="StateStatus" value="2" @if($ResumeDetail->StateStatus == 2) checked @endif>
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="text-danger">Not Approve:</label>
                                    <input type="radio" name="PincodeStatus" value="1"  @if($ResumeDetail->PincodeStatus == 1) checked @endif>


                                    <label class="text-success">Approve:</label>
                                    <input type="radio" name="PincodeStatus" value="2" @if($ResumeDetail->PincodeStatus == 2) checked @endif>
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="text-danger">Not Approve:</label>
                                    <input type="radio" name="MobileStatus" value="1" @if($ResumeDetail->MobileStatus == 1) checked @endif>


                                    <label class="text-success">Approve:</label>
                                    <input type="radio" name="MobileStatus" value="2" @if($ResumeDetail->MobileStatus == 2) checked @endif>
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="text-danger">Not Approve:</label>
                                    <input type="radio" name="EmailIdStatus" value="1" @if($ResumeDetail->EmailIdStatus == 1) checked @endif>


                                    <label class="text-success">Approve:</label>
                                    <input type="radio" name="EmailIdStatus" value="2" @if($ResumeDetail->EmailIdStatus == 2) checked @endif>
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="text-danger">Not Approve:</label>
                                    <input type="radio" name="SSCResultStatus" value="1"  @if($ResumeDetail->SSCResultStatus == 1) checked @endif>


                                    <label class="text-success">Approve:</label>
                                    <input type="radio" name="SSCResultStatus" value="2" @if($ResumeDetail->SSCResultStatus == 2) checked @endif>
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="text-danger">Not Approve:</label>
                                    <input type="radio" name="SSCPassingYearStatus" value="1" @if($ResumeDetail->SSCPassingYearStatus == 1) checked  @endif>


                                    <label class="text-success">Approve:</label>
                                    <input type="radio" name="SSCPassingYearStatus" value="2" @if($ResumeDetail->SSCPassingYearStatus == 2) checked @endif>
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="text-danger">Not Approve:</label>
                                    <input type="radio" name="SSCBoardUniversityStatus" value="1" @if($ResumeDetail->SSCBoardUniversityStatus == 1) checked @endif>


                                    <label class="text-success">Approve:</label>
                                    <input type="radio" name="SSCBoardUniversityStatus" value="2" @if($ResumeDetail->SSCBoardUniversityStatus == 2) checked @endif>
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="text-danger">Not Approve:</label>
                                    <input type="radio" name="HSCResultStatus" value="1" @if($ResumeDetail->HSCResultStatus == 1) checked @endif>


                                    <label class="text-success">Approve:</label>
                                    <input type="radio" name="HSCResultStatus" value="2" @if($ResumeDetail->HSCResultStatus == 2) checked @endif>
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="text-danger">Not Approve:</label>
                                    <input type="radio" name="HSCBoardUniversityStatus" value="1" @if($ResumeDetail->HSCBoardUniversityStatus == 1) checked @endif>


                                    <label class="text-success">Approve:</label>
                                    <input type="radio" name="HSCBoardUniversityStatus" value="2" @if($ResumeDetail->HSCBoardUniversityStatus == 2) checked @endif>
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="text-danger">Not Approve:</label>
                                    <input type="radio" name="HSCPassingYearStatus" value="1"  @if($ResumeDetail->HSCPassingYearStatus == 1) checked @endif>


                                    <label class="text-success">Approve:</label>
                                    <input type="radio" name="HSCPassingYearStatus" value="2" @if($ResumeDetail->HSCPassingYearStatus == 2) checked @endif>
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="text-danger">Not Approve:</label>
                                    <input type="radio" name="DiplomaDegreeStatus" value="1" @if($ResumeDetail->DiplomaDegreeStatus == 1) checked @endif>


                                    <label class="text-success">Approve:</label>
                                    <input type="radio" name="DiplomaDegreeStatus" value="2" @if($ResumeDetail->DiplomaDegreeStatus == 2) checked @endif>
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="text-danger">Not Approve:</label>
                                    <input type="radio" name="DiplomaResultStatus" value="1" @if($ResumeDetail->DiplomaResultStatus == 1) checked @endif>


                                    <label class="text-success">Approve:</label>
                                    <input type="radio" name="DiplomaResultStatus" value="2" @if($ResumeDetail->DiplomaResultStatus == 2) checked @endif>
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="text-danger">Not Approve:</label>
                                    <input type="radio" name="DiplomaUniversityStatus" value="1" @if($ResumeDetail->DiplomaUniversityStatus == 1) checked @endif>


                                    <label class="text-success">Approve:</label>
                                    <input type="radio" name="DiplomaUniversityStatus" value="2" @if($ResumeDetail->DiplomaUniversityStatus == 2) checked @endif>
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="text-danger">Not Approve:</label>
                                    <input type="radio" name="DiplomaYearStatus" value="1" @if($ResumeDetail->DiplomaYearStatus == 1) checked @endif>


                                    <label class="text-success">Approve:</label>
                                    <input type="radio" name="DiplomaYearStatus" value="2" @if($ResumeDetail->DiplomaYearStatus == 2) checked  @endif>
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="text-danger">Not Approve:</label>
                                    <input type="radio" name="GraduationResultStatus" value="1" @if($ResumeDetail->GraduationResultStatus == 1) checked @endif>


                                    <label class="text-success">Approve:</label>
                                    <input type="radio" name="GraduationResultStatus" value="2" @if($ResumeDetail->GraduationResultStatus == 2) checked @endif>
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="text-danger">Not Approve:</label>
                                    <input type="radio" name="GraduationUniversityStatus" value="1" @if($ResumeDetail->GraduationUniversityStatus == 1) checked @endif>


                                    <label class="text-success">Approve:</label>
                                    <input type="radio" name="GraduationUniversityStatus" value="2" @if($ResumeDetail->GraduationUniversityStatus == 2) checked @endif>
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="text-danger">Not Approve:</label>
                                    <input type="radio" name="GraduationYearStatus" value="1" @if($ResumeDetail->GraduationYearStatus == 1) checked @endif>


                                    <label class="text-success">Approve:</label>
                                    <input type="radio" name="GraduationYearStatus" value="2" @if($ResumeDetail->GraduationYearStatus == 2) checked @endif>
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="text-danger">Not Approve:</label>
                                    <input type="radio" name="GraduationDegreeStatus" value="1" @if($ResumeDetail->GraduationDegreeStatus == 1) checked @endif>


                                    <label class="text-success">Approve:</label>
                                    <input type="radio" name="GraduationDegreeStatus" value="2" @if($ResumeDetail->GraduationDegreeStatus == 2) checked @endif>
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="text-danger">Not Approve:</label>
                                    <input type="radio" name="PostGraduationDegreeStatus" value="1" @if($ResumeDetail->PostGraduationDegreeStatus == 1) checked @endif>


                                    <label class="text-success">Approve:</label>
                                    <input type="radio" name="PostGraduationDegreeStatus" value="2" @if($ResumeDetail->PostGraduationDegreeStatus == 2) checked @endif>
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="text-danger">Not Approve:</label>
                                    <input type="radio" name="PostGraduationResultStatus" value="1" @if($ResumeDetail->PostGraduationResultStatus == 1) checked @endif>


                                    <label class="text-success">Approve:</label>
                                    <input type="radio" name="PostGraduationResultStatus" value="2" @if($ResumeDetail->PostGraduationResultStatus == 2) checked @endif>
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="text-danger">Not Approve:</label>
                                    <input type="radio" name="PostGraduationUniversityStatus" value="1" @if($ResumeDetail->PostGraduationUniversityStatus == 1) checked @endif>


                                    <label class="text-success">Approve:</label>
                                    <input type="radio" name="PostGraduationUniversityStatus" value="2" @if($ResumeDetail->PostGraduationUniversityStatus == 2) checked @endif>
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="text-danger">Not Approve:</label>
                                    <input type="radio" name="PostGraduationYearStatus" value="1" @if($ResumeDetail->PostGraduationYearStatus == 1) checked @endif>


                                    <label class="text-success">Approve:</label>
                                    <input type="radio" name="PostGraduationYearStatus" value="2" @if($ResumeDetail->PostGraduationYearStatus == 2) checked @endif>
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="text-danger">Not Approve:</label>
                                    <input type="radio" name="HighestLevelEducationStatus" value="1" @if($ResumeDetail->HighestLevelEducationStatus == 1) checked @endif>


                                    <label class="text-success">Approve:</label>
                                    <input type="radio" name="HighestLevelEducationStatus" value="2" @if($ResumeDetail->HighestLevelEducationStatus == 2) checked @endif>
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="text-danger">Not Approve:</label>
                                    <input type="radio" name="TotalWorkExpesienceYearStatus" value="1" @if($ResumeDetail->TotalWorkExpesienceYearStatus == 1) checked @endif>


                                    <label class="text-success">Approve:</label>
                                    <input type="radio" name="TotalWorkExpesienceYearStatus" value="2" @if($ResumeDetail->TotalWorkExpesienceYearStatus == 2) checked @endif>
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="text-danger">Not Approve:</label>
                                    <input type="radio" name="TotalWorkExpesienceMonthStatus" value="1" @if($ResumeDetail->TotalWorkExpesienceMonthStatus == 1) checked @endif>


                                    <label class="text-success">Approve:</label>
                                    <input type="radio" name="TotalWorkExpesienceMonthStatus" value="2" @if($ResumeDetail->TotalWorkExpesienceMonthStatus == 2) checked @endif>
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="text-danger">Not Approve:</label>
                                    <input type="radio" name="TotalCompaniesWorkedStatus" value="1"  @if($ResumeDetail->TotalCompaniesWorkedStatus == 1) checked @endif>


                                    <label class="text-success">Approve:</label>
                                    <input type="radio" name="TotalCompaniesWorkedStatus" value="2" @if($ResumeDetail->TotalCompaniesWorkedStatus == 2) checked @endif>
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="text-danger">Not Approve:</label>
                                    <input type="radio" name="LastCurrentEmployerStatus" value="1" @if($ResumeDetail->LastCurrentEmployerStatus == 1) checked @endif>


                                    <label class="text-success">Approve:</label>
                                    <input type="radio" name="LastCurrentEmployerStatus" value="2" @if($ResumeDetail->LastCurrentEmployerStatus == 2) checked @endif>
