                        ...
                        <table id="healthConditionDatatable" class="table table-striped table-bordered table-hover dataTables-example" style="width: 100%;">
                            <thead>
                                <tr>
                                    ...
                                    <th>Start Date</th>
                                    <th>End Date</th>
                                    <th>Resume Submit Count</th>
                                    <th>Move to submit</th>
                                </tr>
                            </thead>
                        </table>
                    </div>
...
@section('footer')
    ...
    <script>
        ...
        $('#endDateRange').daterangepicker({
           ...
           var oTable  =  $('#healthConditionDatatable').DataTable({
                ...
                serverSide: true,
                ajax: {
          url: "{{ route('UserReviewDataTableSubmit') }}",
          data: function (d) {
            ...
            columns: [
                    ...
                    {
                        data: 'ResumeSubmitCount',
                        name: 'ResumeSubmitCount',
                    },
                    {
                        data: 'move',
                        name: 'move',
    ...
    exportOptions: {
       ...
       var urlpath = url('admin/client/resumedetailsubmit');
                $.ajax({
                    url: urlpath,
                    data: {
