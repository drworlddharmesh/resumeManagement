            ...
            <div class="ibox">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools">
                        <a href="{{ url('admin/agreement/add-agreement') }}" class="btn btn-sm btn-primary m-t-n-xs">
                            Add New Agreement
                        </a>
...
@section('footer')
    ...
    exportOptions: {
        ...
        function DeleteHealthCondition(AgreementId) {
            swal({
                ...
                $.ajax({
                    url: 'agreement/delete-agreement',
                    type: 'POST',
                    data: {
                        "_token": "{{ csrf_token() }}",
