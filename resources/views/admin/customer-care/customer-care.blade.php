        ...
        <div class="col-lg-12">
            <div class="ibox">
                <div class="ibox-title">
                    <h5>Customer Care List</h5>

                    <div class="ibox-tools">
                        <a href="{{ url('admin/customer-care/add-customer-care') }}" class="btn btn-sm btn-primary m-t-n-xs">
                            Add New Customer Care
                        </a>
...
@section('footer')
    ...
    <script>
        $(document).ready(function(){
            ...
            proccessing: true,
            serverSide: true,
            ajax: '{!! route('CustomerCareDataTable') !!}',
            columns: [
                    {
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
    ...
    exportOptions: {
        ...
        function DeleteHealthCondition(CallerId) {
            swal({
                title: "Delete Customer Care",
                text: "Are you sure you want to delete this Customer Care?",
                type: "warning",
                ...
                $.ajax({
                    url: 'customer-care/delete-customer-care',
                    type: 'POST',
                    data: {
                        "_token": "{{ csrf_token() }}",
                        CallerId: CallerId,
