        ...
        <div class="col-lg-12">
            <div class="ibox">
                ...
                <div class="ibox-content">
                    ...
                    <form role="form" id="addSubAdminForm" method="post" enctype="multipart/form-data" action="{{ url('admin/insert-sub-admin') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="MoblieNumber" id="MoblieNumber" placeholder="Please Enter Moblie Number" class="form-control">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label>Email:</label>
                                    <input type="email" name="Email" id="Email" placeholder="Please Enter Email" class="form-control">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label>Address:</label>
                                    <textarea name="Address" id="Address" placeholder="Please Enter Address" class="form-control"></textarea>
                                </div>
                            </div>
                            {{-- <div class="col-sm-6">
                                <div class="form-group">
                                        ...
                                        @foreach($Manu as $mn)
                                            <div class="col-sm-3">
                                                <label class="simple-checkbox">
                                                    <input type="checkbox" name="menu[]" value="{{ $mn->ManuId }}">
                    ...
                    @if(Session::has('SubAdminRegistrationEmail'))
                        <div class="table-responsive">
                            <table class="table  table-bordered table-hover">
                                ...
                                <tbody>
                                    <tr>
                                        <td>Registration Id:- {{ Session::get('SubAdminRegistrationEmail') }}</td>
                                    </tr>
                                    <tr>
                                    <td>Password:- {{ Session::get('SubAdminPassword') }}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
...
<script>
    ...
    $.validator.addMethod('checkexistemail', function(value, element) {
        ...
        $.ajax({
            url: 'client/check-dublication-email',
            type: 'POST',
            async: false,
            data: {
                _token: '{{ csrf_field() }}',
