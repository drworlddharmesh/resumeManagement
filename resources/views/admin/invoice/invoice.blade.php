...
<body style="padding: 10px 20px">
	...
	<table border="1px solid" width="100%" style="border-collapse: collapse">
        ...
        <tr>
            ...
            <td style="padding: 4px;"></td>
            <td colspan="2" style="text-align: right; padding: 4px;"><p style="margin: unset;"><b>{{$WithoutGSTAmount}}</b></p></td>
        </tr>
        ...
        <tr style="border-top: unset; border-bottom: unset;">
            ...
            <td colspan="2" style="padding: 4px;"><br></td>
            <td style="text-align: right; padding: 4px;"><p style="margin: unset;"><b>{{$GST}}</b></p></td>
            <td style="text-align: center; padding: 4px;"><p style="margin: unset;"><b>%</b></p></td>
            <td colspan="2" style="text-align: right; padding: 4px;"><p style="margin: unset;"><b>{{$GSTAmount}}</b></p></td>
        </tr>
        ...
        <tr>
            ...
            <td style="padding: 4px;"></td>
            <td style="padding: 4px;"></td>
            <td colspan="2" style="text-align: center; padding: 4px;"><p style="margin: unset;"><b>Rs.{{$TotalAmount}}</b></p></td>
        </tr>
