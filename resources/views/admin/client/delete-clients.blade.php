    ...
    <div class="col-lg-12">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">
                <strong>Multiple Delete Registration</strong>
            </li>
        </ol>
    </div>
</div>
        ...
        <div class="col-lg-12">
            <div class="ibox">
                <div class="ibox-title">
                    <h5>Multiple Delete Registration</h5>
                ...
                <div class="ibox-content">
                    ...
                    <form role="form" id="addHealthConditionForm" method="post" enctype="multipart/form-data" action="{{ url('admin/client/delete-client/clients_delete') }}">
                        {{ csrf_field() }}
