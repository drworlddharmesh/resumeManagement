            ...
            <div class="ibox">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools">
                        <a href="{{ url('admin/franchisee/add-franchisee') }}" class="btn btn-sm btn-primary m-t-n-xs">
                            Add New Franchisee
                        </a>
...
@section('footer')
    ...
    <script>
        $(document).ready(function(){
            ...
            proccessing: true,
            serverSide: true,
            ajax: '{!! route('FranchiseerDataTable') !!}',
            columns: [
                    {
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
    ...
    exportOptions: {
        ...
        function DeleteHealthCondition(FranchiseeId) {
            swal({
                title: "Delete Franchisee",
                text: "Are you sure you want to delete this Franchisee?",
                type: "warning",
                ...
                $.ajax({
                    url: 'franchisee/delete-franchisee',
                    type: 'POST',
                    data: {
                        "_token": "{{ csrf_token() }}",
