            ...
            <div class="ibox">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools">
                        <a href="{{ url('admin/resume/add-resume') }}" class="btn btn-sm btn-primary m-t-n-xs">
                            Add New Resume
                        </a>
                        ...
                        <table id="healthConditionDatatable" class="table table-striped table-bordered table-hover dataTables-example">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>Resume</th>
                                    <th class="text-center">Resume Create Date</th>
...
@section('footer')
    ...
    exportOptions: {
        ...
        function DeleteHealthCondition(ResumeId) {
            swal({
                title: "Delete Resume",
